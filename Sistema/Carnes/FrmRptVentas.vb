...
Public Class FrmRptVentas
    ...
    Private Sub FrmRptVentas_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        ENVIAR_ENTER(e.KeyChar)
    End Sub

    Private Sub FrmRptVentas_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    '    Dim ClsProc As New ClsFacturacionCab

    '    Try
    '        FRM.MdiParent = Me.MdiParent
    '        FRM.Text = "REPORTE DE VENTAS"
    '        FRM.ReportViewer1.LocalReport.ReportEmbeddedResource = "Carnes.RptVentas.rdlc"
    '        DT = ClsProc.RPTVentas(CMBEstado.Text.Trim, DtpDesde.Value, DtpHasta.Value)
    '        RD.Value = DT
    '        RD.Name = "DataSet1"
