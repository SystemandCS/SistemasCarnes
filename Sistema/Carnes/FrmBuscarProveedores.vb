Public Class FrmBuscarProveedores
    ...
    Private Sub RellenarLista(CLICOD As String, CLIRAZONSOCIAL As String, CLIRUC As String)
        Try
            ...
            DT = CProveedores.ListaProveedores(CLICOD, CLIRAZONSOCIAL, CLIRUC)
    ...
    Private Sub FrmBuscar_Proveedores_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub

    Private Sub FrmBuscar_Proveedores_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        ENVIAR_ENTER(e.KeyChar)
    End Sub

    Private Sub FrmBuscar_Proveedores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        RellenarLista("", "", "")
        Limpiar()
    End Sub
