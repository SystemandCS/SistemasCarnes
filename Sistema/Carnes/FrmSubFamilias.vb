Public Class FrmSubFamilias
    ...
    Private Sub RellenarLista(Valor As String)
        Try
            ...
            DT = CSubFamilia.ListaSubFamilias(Valor)
    ...
    Private Sub BuscaRegistro(Codigo As String)
        Try
            Dim CSubFamilias As New ClsSubFamilias
            Dim DT As New DataTable
            DT = CSubFamilias.BuscaSubFamilias(Codigo)
            If DT.Rows.Count > 0 Then
                TxtCodigo.Text = DT.Rows(0).Item("SUBFAMCOD").ToString()
                txtDescripcion.Text = DT.Rows(0).Item("SUBFAMDES").ToString()
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End Try
    ...
    Private Sub BtnGrabar_Click(sender As Object, e As EventArgs) Handles BtnGrabar.Click
        ...
        Try
            If TxtCodigo.Text.Trim = "" Then
                Retorno = CSubFamilia.InsertaSubFamilias(txtDescripcion.Text.Trim, USUCOD)
                ...
                End If
            Else
                Retorno = CSubFamilia.ActualizaSubFamilias(TxtCodigo.Text, txtDescripcion.Text.Trim, USUCOD)
                If Val(Retorno) > 0 Then
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        Dim CSubFamilia As New ClsSubFamilias
        Try
            Retorno = CSubFamilia.EliminaSubFamilias(TxtCodigo.Text)
            If Val(Retorno) = 0 Then
    ...
    Private Sub FrmSubFamilias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call BtnNuevo_Click(sender, e)
    End Sub

    Private Sub FrmSubFamilias_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub

    Private Sub FrmSubFamilias_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
