Public Class FrmBuscarFacturacion
    ...
    Private Sub RellenarLista(FACCOD As String, SERIE As String, CORRELATIVO As String, CLICOD As String, DESDE As Date, HASTA As Date)
        Try
            Dim CFacCab As New ClsFacturacionCab
            Dim DT As New DataTable
            DT = CFacCab.ListaFacturacionCab(FACCOD, SERIE, CORRELATIVO, CLICOD, DESDE, HASTA)
    ...
    Private Sub FrmBuscarFacturacion_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub

    Private Sub FrmBuscarFacturacion_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        ENVIAR_ENTER(e.KeyChar)
    End Sub

    Private Sub FrmBuscarFacturacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
